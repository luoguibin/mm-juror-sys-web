...
let apiData = JSON.parse(sessionStorage.getItem("mm-juror-sys-mock-data"));
if (!apiData) {
    apiData = {
        // 数据初始化时间
    ...
    // 承办人
    const count = Math.floor(apiData.jurors.length * 0.3) || 0;
